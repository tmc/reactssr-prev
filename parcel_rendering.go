...
// RenderParcelReactApp renders a react application that has been bundled with the parcel packager.
func RenderParcelReactApp(manifestPath, path, entrypoint string) (template.HTML, template.CSS, error) {
